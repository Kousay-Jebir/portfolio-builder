...
let UserService = class UserService extends base_service_1.BaseService {
    userModel;
    userDataModel;
    constructor(userModel, userDataModel) {
        super(userModel);
    ...
    async createPersonalData(personalDataDto, user) {
...
exports.UserService = UserService = __decorate([
    ...
    __param(1, (0, mongoose_1.InjectModel)(user_personal_entity_1.UserPersonalData.name)),
