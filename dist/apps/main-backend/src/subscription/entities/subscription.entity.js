...
const subscription_type_enum_1 = require("../../enum/subscription-type.enum");
...
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: subscription_type_enum_1.SubscriptionType, required: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Date)
], Subscription.prototype, "deleteAt", void 0);
__decorate([
...
exports.SubscriptionSchema.index({ deleteAt: 1 }, { expireAfterSeconds: 0 });
